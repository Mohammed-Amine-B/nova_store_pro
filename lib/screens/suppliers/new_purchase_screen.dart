...
class NewPurchaseScreen extends StatefulWidget {
  ...
  const NewPurchaseScreen({super.key, required this.db, this.supplierId, this.purchaseId});
...
class _NewPurchaseScreenState extends State<NewPurchaseScreen> {
  ...
  Future<(double, double, double?)?> _askQuantityAndPrice(Product product) async {
                      ...
                      child: ConstrainedBox(
                        ...
                        child: DataTable(
                          columns: [
                            ...
                            DataColumn(label: Text(l10n.buyPriceLabel), numeric: true),
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      formatMoney(widget.isEditMode ? _total : _total + _previousOwed),
          ...
          child: Padding(
            ...
            child: widget.isEditMode
                ? Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      _SummaryRow(l10n.colPaid, formatMoney(_existingPurchase?.amountPaid ?? 0)),
                      const SizedBox(height: 10),
                      _SummaryRow(
                        l10n.colRemaining,
                        formatMoney((_existingPurchase?.totalAmount ?? 0) - (_existingPurchase?.amountPaid ?? 0)),
                      ),
                      const SizedBox(height: 12),
                      Text(
        ...
        if (!widget.isEditMode) ...[
          ...
          SizedBox(
            ...
            child: FilledButton(
              ...
              child: Text(l10n.confirmPurchaseAction, style: const TextStyle(fontWeight: FontWeight.w700)),
            ),
          ),
        ],
      ],
            ...
            children: [
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(widget.isEditMode ? l10n.editPurchaseTooltip : l10n.newPurchaseAction,
                        style: theme.textTheme.headlineSmall?.copyWith(fontWeight: FontWeight.w700)),
                    const SizedBox(height: 2),
                    Text(
                      widget.isEditMode ? l10n.editingPurchaseNum('${widget.purchaseId}') : l10n.draftNotSaved,
                      style: theme.textTheme.bodySmall?.copyWith(color: theme.colorScheme.onSurface.withValues(alpha: 0.5)),
                    ),
                  ],
                ),
                  ...
                  child: Row(
                    ...
                    children: [
                      CircleAvatar(
                        ...
                        child: Text(supplier.name.isNotEmpty ? supplier.name[0].toUpperCase() : '?', style: const TextStyle(fontSize: 12)),
                      ),
