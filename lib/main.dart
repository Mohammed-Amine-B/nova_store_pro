...
class _NovaStoreAppState extends State<NovaStoreApp> {
  ...
  void initState() {
    ...
    setState(() {
      ...
      _unlocked = settings.appPasswordHash == null || settings.appPasswordHash!.isEmpty;
      _loading = false;
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      theme: AppTheme.light.copyWith(textTheme: _withWeight(AppTheme.light.textTheme, fontWeight)),
      darkTheme: AppTheme.dark.copyWith(textTheme: _withWeight(AppTheme.dark.textTheme, fontWeight)),
